...
export class TableComponent implements OnDestroy{
  ...
  constructor(
    ...
    router.events.subscribe((val) => {  this.loading = true;
      // see also  
  ...
  frameworkComponents = {
   ...
   this.subscriotion =  this.entity.update(this.entityData.apiSelector, data, data.id).subscribe(res =>{
   ...
   onDeleteClick(event) {
    ...
    if (confirm(this.translate.instant("sure?"))) {
      this.subscriotion =  this.entity.delete(this.entityData.apiSelector, data, data.id).subscribe(res => {
