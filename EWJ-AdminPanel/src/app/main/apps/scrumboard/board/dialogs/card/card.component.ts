...
export class ScrumboardCardDialogComponent implements OnInit, OnDestroy {
    ...
    trasferDialogRef: MatDialogRef<BoardListComponent, any>;
  ...
  */
    TransferBoard(): void {
        ...
        this.trasferDialogRef = this._matDialog.open(BoardListComponent,{
            disableClose: false,
            data:{
                card: this.card,
                list: this.list,
        ...
        //     }
        // });
        // console.log(this.card,this.list,);
        // 
        // this._scrumboardService.removeCard(this.card.id, this.list.id);
    }
