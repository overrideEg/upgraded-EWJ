        ...
        switch (f.type) {
            case FieldType.entity: {
                return this.fb.control(
                    {
                        value: f.initialValue || f.multiple ? [] : {},
                        disabled: f.disabled,
                    },
            ...
            case FieldType.checkbox: {
                return this.fb.control(
                    { value: f.initialValue || false, disabled: f.disabled },
                    f.validators ? f.validators : []
                );
            }
            ...
            case FieldType.group: {
                ...
                // console.log(childs);
                return this.fb.group(childs, f.validators ? f.validators : []);
            }
