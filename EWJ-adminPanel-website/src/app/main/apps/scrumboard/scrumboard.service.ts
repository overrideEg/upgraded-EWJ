...
export class ScrumboardService implements Resolve<any>
{
    ...
    getBoards(): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            this.entity.getAll("Board").subscribe((response: any) => {
    ...
    getBoard(boardId): Promise<any> {
        return new Promise((resolve, reject) => {
            this.entity.getOne("Board", boardId)
                .subscribe((response: any) => {
    ...
    updateBoard(): Promise<any> {
        return new Promise((resolve, reject) => {
            this.entity.update("Board", this.board, this.board.id).subscribe(response => {
                this.onBoardChanged.next(this.board);
                resolve(this.board);
            }, reject);
    ...
    createNewBoard(board): Promise<any> {
        return new Promise((resolve, reject) => {
            this.entity.save("Board", board).subscribe(response => {
